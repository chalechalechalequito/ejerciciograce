package com.ejemplo.ejerciciograce;
...
public class graceacts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graceacts);

        etTexto = (EditText) findViewById(R.id.edit);
        btnBoton = (Button) findViewById(R.id.butt);
